...
var wasmSourceMapFile = "hashibridges.wasm.map";
...
function findWasmBinary() {
  return locateFile("hashibridges.wasm");
}
...
var ASM_CONSTS = {
  ...
  328569: () => Module.canvas.width,
  328601: () => parseInt(Module.canvas.style.width),
  328649: () => {
  ...
  329072: () => window.innerWidth,
  329098: () => window.innerHeight,
  329125: () => {
    if (document.fullscreenElement) return 1;
  },
  329171: () => Module.canvas.width,
  329203: () => parseInt(Module.canvas.style.width),
  329251: () => {
    if (document.fullscreenElement) return 1;
  },
  329297: () => Module.canvas.width,
  329329: () => screen.width,
  329354: () => window.innerWidth,
  329380: () => window.innerHeight,
  329407: () => {
    if (document.fullscreenElement) return 1;
  },
  329453: () => Module.canvas.width,
  329485: () => screen.width,
  329510: () => {
    document.exitFullscreen();
  },
  ...
  329583: () => Module.canvas.width,
  329615: () => parseInt(Module.canvas.style.width),
  329663: () => {
    document.exitFullscreen();
  },
  329690: $0 => {
  ...
  329728: () => screen.width,
  329753: () => screen.height,
  329779: () => window.screenX,
  329806: () => window.screenY,
  329833: () => window.devicePixelRatio,
  329869: $0 => {
  ...
  330410: () => window.innerWidth,
  330436: () => window.innerHeight
};
